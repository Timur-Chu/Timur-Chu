...
<tr>
  ...
  <td>Прогнозирование продаж, сбор информации и анализ состояния рынка. Расчеты кейсов по запуску инициатив, направленных на увеличение продаж продаж. </td>
  <td>20.04.19</td>
  <td>01.08.22</td>
</tr> 
...
<tr>
  ...
  <td> Организация продаж во франшизной рознице. Проведение расчетов и тэхнико-экономических обоснований для открытий салонов. Создание отчетности для  оперативного информирования розницы по текущим выполнениям показателей. Прогнозирование продаж.  </td>
  <td>01.11.16</td>
  <td>20.04.19</td>
</tr> 
...
<tr>
  ...
  <td>Яндекс.Практикум</td>
  <td>	Интернет-магазин, который продаёт по всему миру компьютерные игры, проводит анализ данных из открытых источников, чтобы определить закономерности определяющие успешность игры.</td>
  <td>Завершен</td>
</tr> 
...
<tr>
  <td><a href = "https://github.com/Timur-Chu/gold_recovery_prediction">Предсказание коэффициента восстановления золота из золотосодержащей руды</a></td>
  <td>Яндекс.Практикум</td>
  <td>Необходимо подготовить прототип модели машинного обучения для ее использования в золотодобывающей отрасли. Модель должна предсказать коэффициент восстановления золота из золотосодержащей руды</td>
  <td>Завершен</td>
</tr>
...
<tr>
  <td><a href = "https://github.com/Timur-Chu/taxi_orders_forecast">Прогнозирование заказов такси</a></td>
  <td>Яндекс.Практикум</td>
  <td>С целью привлечения большего количества водителей в период пиковой нагрузки, нужно спрогнозировать количество заказов такси. Необходимо построить модель для такого предсказания</td>
  <td>Завершен</td>
</tr>
...
<tr>
  <td><a href = "https://github.com/Timur-Chu/comments_classifying">Классификация токсичных комментариев</a></td>
  <td>Яндекс.Практикум</td>
